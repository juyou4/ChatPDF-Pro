...
_VISION_CAPABLE_MODEL_RULES: dict[str, re.Pattern[str]] = {
    ...
    "zhipu": re.compile(r"^glm-5\.3-flash", re.IGNORECASE),
    "qwen": re.compile(r"^(qwen-vl|qwen-max|glm-5\.3-flash)", re.IGNORECASE),
    "aliyun": re.compile(r"^(qwen-vl|qwen-max|qwen3\.[5678]|qwen3\.5-omni|glm-5\.3-flash)", re.IGNORECASE),
