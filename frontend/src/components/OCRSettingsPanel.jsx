                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-10 py-2.5 text-sm rounded-xl border border-gray-200 bg-white/60 focus:border-blue-300 focus:ring-2 focus:ring-blue-100 outline-none transition-all placeholder:text-gray-300"
                      />
                      {/* 显示/隐藏 API Key 切换按钮 */}
                      <button
                        type="button"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-2.5 text-sm rounded-xl border border-gray-200 bg-white/60 focus:border-blue-300 focus:ring-2 focus:ring-blue-100 outline-none transition-all placeholder:text-gray-300"
                      />
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 px-4 py-2 text-xs font-medium rounded-xl border border-blue-200 bg-blue-50/60 text-blue-700 hover:bg-blue-100/60 disabled:opacity-40 disabled:cursor-not-allowed transition-all"
                    >
                        ...
                        <button
                          ...
                          className={`flex-1 px-3 py-2 text-xs font-medium rounded-xl border transition-all ${
                            mineruTokenMode === 'frontend'
                              ? 'border-blue-200 bg-blue-50/60 text-blue-700 shadow-sm'
                              : 'border-gray-200 bg-white/60 text-gray-600 hover:border-blue-200 hover:bg-blue-50/30'
                          }`}
                        >
                          前端透传
                        </button>
                      ...
                      <div className="space-y-2">
                        ...
                        <label className="flex items-center justify-between px-3 py-2 rounded-xl bg-gray-50/80 border border-gray-100 cursor-pointer">
                          ...
                          <div
                            ...
                            className={`relative w-9 h-5 rounded-full transition-colors cursor-pointer ${
                              mineruEnableOcr ? 'bg-blue-500' : 'bg-gray-300'
                            }`}
                          >
                            <div
                        ...
                        <label className="flex items-center justify-between px-3 py-2 rounded-xl bg-gray-50/80 border border-gray-100 cursor-pointer">
                          ...
                          <div
                            ...
                            className={`relative w-9 h-5 rounded-full transition-colors cursor-pointer ${
                              mineruEnableFormula ? 'bg-blue-500' : 'bg-gray-300'
                            }`}
                          >
                            <div
                              className={`absolute top-0.5 left-0.5 w-4 h-4 rounded-full bg-white shadow transition-transform ${
                        ...
                        <label className="flex items-center justify-between px-3 py-2 rounded-xl bg-gray-50/80 border border-gray-100 cursor-pointer">
                          ...
                          <div
                            ...
                            className={`relative w-9 h-5 rounded-full transition-colors cursor-pointer ${
                              mineruEnableTable ? 'bg-blue-500' : 'bg-gray-300'
                            }`}
                          >
                            <div
                              className={`absolute top-0.5 left-0.5 w-4 h-4 rounded-full bg-white shadow transition-transform ${
