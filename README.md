...
[应用预览](#应用预览) · [解析路线](#解析路线) · [核心能力](#核心能力) · [快速开始](#快速开始) · [评测](#ragas-评测) · [English](README_EN.md)
...
回答中的 `[1]` `[2]` 只关联本轮实际读取的证据，点击即可回到 PDF。思考过程默认折叠，公式、Markdown 和 Mermaid 可以直接渲染。
...
| 视觉模型 | 可选 | 图表解读和表格视觉核验；可跟随具备视觉能力的对话模型 |
...
当前版本为 [v3.1.0](https://github.com/juyou4/ChatPDF-Pro/releases/tag/v3.1.0)。完整变更记录以 [Git 提交历史](https://github.com/juyou4/ChatPDF-Pro/commits/main/) 和 Releases 为准。
