...
<!-- 请将速览截图放入 docs/ 目录，并将下方文件名替换为实际文件名 -->
![界面速览](docs/preview_overview.png)

*整体界面布局：左侧为原生 PDF 阅读区，右侧为 AI 对话区，中间可拖动调整比例。支持多文档标签、对话历史管理与一键预设问题。*

### 对话示例

<!-- 请将对话截图放入 docs/ 目录，并将下方文件名替换为实际文件名 -->
![AI 对话示例](docs/preview_chat.png)

*AI 对话区效果：引文编号 [1][2] 可点击跳转至 PDF 对应位置，内联数学公式实时渲染，深度思考过程可折叠展示，对话底部附追问建议按钮。*
